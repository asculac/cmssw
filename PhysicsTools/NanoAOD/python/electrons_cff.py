...
slimmedElectronsWithUserData = cms.EDProducer("PATElectronUserDataEmbedder",
    ...
    userFloats = cms.PSet(
        ...
        mvaHZZSummer16ULIdIso = cms.InputTag("electronMVAValueMapProducer:ElectronMVAEstimatorRun2Summer16ULIdIsoValues"),
        mvaHZZSummer17ULIdIso = cms.InputTag("electronMVAValueMapProducer:ElectronMVAEstimatorRun2Summer17ULIdIsoValues"),
        mvaHZZSummer18ULIdIso = cms.InputTag("electronMVAValueMapProducer:ElectronMVAEstimatorRun2Summer18ULIdIsoValues"),
...
electronTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
    ...
    variables = cms.PSet(CandVars,
        ...
        mvaHZZSummer16ULIdIso = Var("userFloat('mvaHZZSummer16ULIdIso')", float,doc="HZZ MVA UL16 Iso ID score"),
        mvaHZZSummer17ULIdIso = Var("userFloat('mvaHZZSummer17ULIdIso')", float,doc="HZZ MVA UL17 Iso ID score"),
        mvaHZZSummer18ULIdIso = Var("userFloat('mvaHZZSummer18ULIdIso')", float,doc="HZZ MVA UL18 Iso ID score"),
